# Deploying the BIG-IP VE in Azure - Single NIC + Custom Config
...
NOTE: This solution also shows what it is like to create some post-deployment configuration as described in the [custom configuration](#deploying-custom-configuration-to-the-big-ip) section of the ARM template.
...
Use the appropriate button, depending on what type of BIG-IP licensing required:
   - **PAYG** <br><a href="https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FF5Networks%2Ff5-azure-arm-templates%2Fagilitydemo%2Fexperimental%2Freference%2Fstandalone%2F1nic+customconfig%2Fnew_stack%2FPAYG%2Fazuredeploy.json">
...
## Deploying Custom Configuration to the BIG-IP
